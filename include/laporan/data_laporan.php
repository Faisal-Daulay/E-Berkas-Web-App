    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <a href="export.php?tgl1=<?php echo $start; ?>&tgl2=<?php echo $end; ?>" class="tombol">Export To Excel</a>
          <a href="pdf/print_laporanmasuk.php?tgl1=<?php echo $start; ?>&tgl2=<?php echo $end; ?>" class="tombol" target="_blank">Export To PDF</a>
          <button type="reset" class="tombol" onclick=self.history.back()>Kembali</button>
        </div>
      </div>
    </div>
  </body>
